...
export const BURNED_PUBKEYS: ReadonlySet<string> = new Set<string>([
  // Payer. Secret exposed in plain text on 2026-09-17; never funded, zero
  // transactions. Purged from .env; kept here so it can never come back.
  '8AhsYWhQpQ43xkMsNey1k3utvyCLuRyHVeDFKr8WJvab',
  // Team keypair auto-generated by a launch.ts dry run on 2026-09-17, which
  // printed its secret. Scripts no longer generate keys.
